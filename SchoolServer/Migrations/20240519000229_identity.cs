        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    course_description = table.Column<string>(type: "text", fixedLength: true, nullable: false),
                    instructor_name = table.Column<string>(type: "char(255)", unicode: false, fixedLength: true, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Country", x => x.course_id);
                });
