...
{
    public class JwtHandler(IConfiguration configuration, UserManager<CourseUser> userManager)
    {
        public async Task<JwtSecurityToken> GetTokenAsync(CourseUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(CourseUser user)
        {
